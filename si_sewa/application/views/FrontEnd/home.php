...
<head>
    ...
    <link href="<?php echo base_url() ?>assets/Frontend/css/camera.css" rel="stylesheet" />
    <link href="<?php echo base_url() ?>assets/Frontend/css/jquery.bxslider.css" rel="stylesheet" />
    <link href="<?php echo base_url() ?>assets/Frontend/css/style.css" rel="stylesheet" />

    <!-- Theme skin -->
    <link href="<?php echo base_url() ?>assets/Frontend/color/default.css" rel="stylesheet" />

    <!-- Fav and touch icons -->
    <link rel="<?php echo base_url() ?>assets/Frontend/apple-touch-icon-precomposed" sizes="144x144" href="ico/apple-touch-icon-144-precomposed.png" />
    <link rel="<?php echo base_url() ?>assets/Frontend/apple-touch-icon-precomposed" sizes="114x114" href="ico/apple-touch-icon-114-precomposed.png" />
    <link rel="<?php echo base_url() ?>assets/Frontend/apple-touch-icon-precomposed" sizes="72x72" href="ico/apple-touch-icon-72-precomposed.png" />
    <link rel="<?php echo base_url() ?>assets/Frontend/apple-touch-icon-precomposed" href="ico/apple-touch-icon-57-precomposed.png" />
    <link rel="<?php echo base_url() ?>assets/Frontend/shortcut icon" href="ico/favicon.png" />
...
<body>
    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <div class="container">
                ...
                <div class="row nomargin">
                    <div class="span4">
                        <div class="logo">
                            <a href="index.html"><img src="<?php echo base_url() ?>assets/Frontend/img/logo2.png" alt="" /></a>
                        </div>
                    </div>
                    <div class="span8">
        ...
        <section id="featured">
            ...
            <div class="camera_wrap" id="camera-slide">
                ...
                <!-- slide 1 here -->
                <div data-src="<?php echo base_url() ?>assets/Frontend/img/slides/camera/slide1/img1.jpg">
                    <div class="camera_caption fadeFromLeft">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="span6">
                                    <img src="<?php echo base_url() ?>assets/Frontend/img/slides/camera/slide1/screen.png" alt="" class="animated bounceInDown delay1" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- slide 2 here -->
                <div data-src="<?php echo base_url() ?>assets/Frontend/img/slides/camera/slide2/img1.jpg">
                    <div class="camera_caption fadeFromLeft">
                        <div class="container">
                            <div class="row">
                                <div class="span6">
                                    <img src="<?php echo base_url() ?>assets/Frontend/img/slides/camera/slide2/iMac.png" alt="" />
                                </div>
                                <div class="span6">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="span12 aligncenter">
                                    ...
                                    <img src="<?php echo base_url() ?>assets/Frontend/img/slides/camera/slide3/browsers.png" alt="" class="animated bounceInDown delay1" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="bxslider">
                            <li>
                                ...
                                <div class="testimonial-autor">
                                    <img src="<?php echo base_url() ?>assets/Frontend/img/dummies/testimonial/1.png" alt="" />
                                    <h4>Hillary Doe</h4>
                            ...
                            <li>
                                ...
                                <div class="testimonial-autor">
                                    <img src="<?php echo base_url() ?>assets/Frontend/img/dummies/testimonial/2.png" alt="" />
                                    <h4>Michael Doe</h4>
                                    <a href="#">www.companyname.com</a>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="testimonial-autor">
                                    <img src="<?php echo base_url() ?>assets/Frontend/img/dummies/testimonial/3.png" alt="" />
                                    <h4>Mark Donovan</h4>
                                    <a href="#">www.companyname.com</a>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="testimonial-autor">
                                    <img src="<?php echo base_url() ?>assets/Frontend/img/dummies/testimonial/4.png" alt="" />
                        ...
                        <div class="row">
                            ...
                            <div class="grid cs-style-4">
                                <div class="span3">
                                    <div class="item">
                                        <figure>
                                            <div><img src="<?php echo base_url() ?>assets/Frontend/img/dummies/works/1.jpg" alt="" /></div>
                                            <figcaption>
                                                <div>
                                                    <span>
                                                        <a href="<?php echo base_url() ?>assets/Frontend/img/dummies/works/big.png" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-plus icon-circled icon-bglight icon-2x"></i></a>
                                                    </span>
                                                    <span>
                                ...
                                <div class="span3">
                                    <div class="item">
                                        <figure>
                                            <div><img src="<?php echo base_url() ?>assets/Frontend/img/dummies/works/2.jpg" alt="" /></div>
                                            <figcaption>
                                                <div>
                                                    <span>
                                                        <a href="<?php echo base_url() ?>assets/Frontend/img/dummies/works/big.png" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-plus icon-circled icon-bglight icon-2x"></i></a>
                                ...
                                <div class="span3">
                                    <div class="item">
                                        <figure>
                                            <div><img src="<?php echo base_url() ?>assets/Frontend/img/dummies/works/3.jpg" alt="" /></div>
                                            <figcaption>
                                                <div>
                                                    <span>
                                                        <a href="<?php echo base_url() ?>assets/Frontend/img/dummies/works/big.png" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-plus icon-circled icon-bglight icon-2x"></i></a>
                                ...
                                <div class="span3">
                                    <div class="item">
                                        <figure>
                                            <div><img src="<?php echo base_url() ?>assets/Frontend/img/dummies/works/4.jpg" alt="" /></div>
                                            <figcaption>
                                                <div>
                                                    <span>
                                                        <a href="<?php echo base_url() ?>assets/Frontend/img/dummies/works/big.png" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-plus icon-circled icon-bglight icon-2x"></i></a>
            ...
            <div id="sub-footer">
                <div class="container">
                    <div class="row">
                        <div class="span6">
                            <div class="copyright">
                                <p><span>&copy; HARSS company. All right reserved</span></p>
                            </div>
    ...
    <script src="<?php echo base_url() ?>assets/Frontend/js/toucheffects.js"></script>
    ...
    <script src="<?php echo base_url() ?>assets/Frontend/js/camera/camera.js"></script>
    <script src="<?php echo base_url() ?>assets/Frontend/js/camera/setting.js"></script>

    <script src="<?php echo base_url() ?>assets/Frontend/js/jquery.prettyPhoto.js"></script>
    <script src="<?php echo base_url() ?>assets/Frontend/js/portfolio/jquery.quicksand.js"></script>
    <script src="<?php echo base_url() ?>assets/Frontend/js/portfolio/setting.js"></script>
    ...
    <script src="<?php echo base_url() ?>assets/Frontend/js/inview.js"></script>
