        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h4 class="m-0 text-dark">Tambah Postingan Tanah</h4>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        ?>
                        <form role="form" action="<?= base_url('pemilik/save_postingan_tanah/' . $kd_pengguna1) ?>" method="POST" enctype="multipart/form-data">
                            <div class="col-md-12">
